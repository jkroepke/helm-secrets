...
### Added
- Add `--skip-decrypt` option and `HELM_SECRETS_SKIP_DECRYPT` environment variable to skip decryption
...
[4.8.0]: https://github.com/kroepke/helm-secrets/compare/v4.7.4...v4.8.0
